...
with-renderer-x:
	gcc -Wall -ggdb3 main.c utils.c compile.c render.c package.c sdom.c ./renderer/renderer.c ./include/glad/glad.c ./include/utils/io.c -o test `pkg-config --libs --cflags glfw3 x11` -lm -I ./include/
